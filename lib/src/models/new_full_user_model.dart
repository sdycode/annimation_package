...
class Project {
  ...
  factory Project.fromMap(Map<String, dynamic> json) => Project(
      ...
      width: ((json['width'] ?? defaultProjectWidth) as num).toDouble(),
      height: ((json['height'] ?? defaultProjectHeight) as num).toDouble(),
...
class IconSection {
  ...
  factory IconSection.fromMap(Map<String, dynamic> json) => IconSection(
      iconSectionNo: ((json["iconSectionNo"] ?? 0)as int),
...
class SingleFrameModel {
  ...
  factory SingleFrameModel.fromMap(Map<String, dynamic> json) =>
      SingleFrameModel(
          frameNo: json["frameNo"] ?? 0,
          framePosition:(( json["framePosition"] ?? 0.0)as num).toDouble(),
